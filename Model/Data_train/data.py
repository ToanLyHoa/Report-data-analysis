...
fhs_sales_flat_order_path = '../../Data/Data_Fahasa/fhs_sales_flat_order.csv'
# Đường dẫn của fhs_sales_flat_order_item
fhs_sales_flat_order_item_path = '../../Data/Data_Fahasa/fhs_sales_flat_order_item.csv'
# Đường dẫn của fhs_sales_flat_order_item
product_dim_path = '../../Data/Data_Fahasa/product_dim.csv'

def prepare_data_date(year = 2020):
          """
          ...
          fhs_sales_flat_order_item_state_year \
          ...
          preprocess_order_item_date = ulti.preprocess_order_item_date
          fhs_sales_flat_order_item_state_year = preprocess_order_item_date(fhs_sales_flat_order_item_state_year)

          fhs_sales_flat_order_item_state_year = fhs_sales_flat_order_item_state_year.sort_values('product_dim.sku')

          return fhs_sales_flat_order_item_state_year

def prepare_data_hour(year = 2020):
          """
          Khởi tạo data chứa những mặt hàng ổn định và số lượng hàng hóa bán trong giờ
          ...
          # preprocess cho bảng fhs_sales_flat_order_item_state_2020
          preprocess_order_item_hour = ulti.preprocess_order_item_hour
          fhs_sales_flat_order_item_state_2020 = preprocess_order_item_hour(fhs_sales_flat_order_item_state_2020)
